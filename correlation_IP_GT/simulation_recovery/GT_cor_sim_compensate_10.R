...
######### medGT expo 7 # compensate another 10 times sim
...
GT_est_total[[4]] <- GT_est_total[[4]]


save(GT_est_total, file = "GT_est_corrsims_medGT_expo7_compensate_extra10_0801.rda")
...
write.csv(df.simsum.expo7.med, file = "sim_performance_expo7_medsetting_compensate_extra10sim.csv")


######### medGT expo 4 # compensate another 10 times sim
...
ind.GT4 # 0 times failed



save(GT_est_total, file = "GT_est_corrsims_medGT_expo4_compensate10_0801.rda")
...
write.csv(df.simsum.expo4.med, file = "sim_performance_expo4_medsetting_compensate10sim.csv")
